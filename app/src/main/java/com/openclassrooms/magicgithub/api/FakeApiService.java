...
public class FakeApiService implements ApiService {
    ...
    public List<User> getUsers() {
        // TODO: A modifier
        //return null;
        return users; // car deja instancié plus haut
    ...
    public void generateRandomUser() {
        // TODO: A modifier
        User user = FakeApiServiceGenerator.FAKE_USERS_RANDOM.get(2); // recupere le nom du no2 en ramdom ; index definis au hasard
        users.add(user); //method add trouvée
    }
    ...
    public void deleteUser(User user) {
        // TODO: A modifier
        users.remove(user); // method remove et non pas clear (voir javadoc) ;
    }
}
